        ...
        BiometricAuthHelper.authenticate(
            ...
            onSuccess = {
                ...
                if (restaurado) {
                    ...
                    Toast.makeText(
                        context,
                        "Huella verificada. Sesión restaurada.",
                        Toast.LENGTH_SHORT
                    ).show()
        ...
        Row(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = if (isLogin) Color(0xFFB39DDB) else Color.Transparent
                )
            ) {
                Text("Iniciar Sesión")
            }
                    ...
                    onClick = {
                        ...
                        if (email.isBlank() || password.isBlank()) {
                            Toast.makeText(
                                context,
                                if (huellaDisponible) {
                                    "Presiona Iniciar sesión para usar huella o escribe tu contraseña."
                                } else {
